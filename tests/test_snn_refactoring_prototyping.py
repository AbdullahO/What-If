...
def test_snn(snn_test_df, snn_expected_query_output):
    ...
    assert snn_expected_query_output.equals(model_query_output), "Query output difference"
    assert model.actions_dict == {"ad 2": 0, "ad 0": 1, "ad 1": 2}, "Actions dict difference"
